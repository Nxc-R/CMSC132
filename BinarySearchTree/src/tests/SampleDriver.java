...
public class SampleDriver {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n======== Marker #2 ========");
		try {
			bst.add("Oliver", 1000).add("Arlene", 50000).add("Terry", 60).add("Qes", 50).add("Cass", 700).add("Bobby", 300);
		...
		System.out.println("\n======== Marker #4 ========");
		KeyValuePair<String, Integer> found = bst.find("Lake");
		...
		System.out.println(bst);
		/*System.out.println(bst.subTree("Oliver", "Tracy"));
		System.out.println(comparator.compare("Oliver", "Tracy"));
		System.out.println(comparator.compare("Tracy", "Oliver"));
		/String t1 = "Oliver";
		String t2 = "Scott";
		System.out.println(t1.compareTo(t2));
		System.out.println(Integer.compare(50, 60));*/
	}
}
